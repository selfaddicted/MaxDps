...
local function drawCustomRotationsScroll(scrollFrame)
	...
	scrollChild.items = scrollChild.items or {}
...
function Window:EditRotation(rotation)
	...
	container.isRotating:SetChecked(rotation.enabled)
...
function Window:ToggleCustomFields(flag, clear)
	...
	if clear then
		...
		container.isRotating:SetChecked(false)
